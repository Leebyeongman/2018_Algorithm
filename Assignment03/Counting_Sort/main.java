...
public class main {
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			dataArray1 = countingSort.countingSort(dataArray1);
			long end1 = System.nanoTime(); // Program end point
			System.out.println("TIME(use counting) : " + ( end1 - start1 )/1000000.0 + "(ms)");

			fileSave("result_"+ arrLength + "_counting.txt", dataArray1); // File save 
		}
	}
